...
def is_valid(puzzle, guess, row, col):
    ...
    #number must not be repeated in the row, column or 3*3 square that it appears in
...
def solve_sudoku(puzzle):
    # solve sodoku using backtracking
    # given sudoku puzzle is a list of lists. where each inner list is a row in our sudoku puzzle
